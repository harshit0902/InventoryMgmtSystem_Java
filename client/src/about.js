        ...
        <div id="AboutUs">
            ...
            <div id="About">
                ...
                <div id="about1">
                    ...
                    <br></br>
                    <br></br>
                    <b>This is a Web Application which implements a basic Inventory Management System. Through this, we will be handling multiple warehouses where we will be getting stocks from several suppliers and supplying the products to numerous clients. We will be maintaining the updated stock of the items after every transaction. We will also be doing a quality check before supplying the products to the clients where we will be checking if the required quality and the quality of items present in the stock match so that only high-value items will be delivered to the customer. Once the client decides to buy the products, payment will be made by the client and an invoice will be generated.</b>
                </div>
            </div>
            <br></br>
            <Footer />
