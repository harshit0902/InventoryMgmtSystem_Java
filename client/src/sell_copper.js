...
function App() {
    ...
    const sellcoppData =JSON.parse(sellcopp);

    function slocalstorage6()
    {
        sellcoppData.quantity = qty1;
        sellcoppData.quality_1 = q1;
        sellcoppData.quality_2 = q2;
        sellcoppData.quality_3 = q3;
   ...
   function Check2(){
    ...
    function Check3(){
      ...
      function Checkqty(){
        if((qty1>0 && qty1 <=25)){    slocalstorage6()        /*variables from backend*/
          console.log("success");
...
return (
    ...
    <center>
      ...
      <div>
        ...
        <input type="number" placeholder='Electrical Conductivity'
      ...
      <div>
        ...
        <input type="number" placeholder='Biofouling Resistance'
      ...
      <div>
        ...
        <input type="number" placeholder='Magnetizability'
