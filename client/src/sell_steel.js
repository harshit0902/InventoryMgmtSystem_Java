...
function App() {
    ...
    const sellsteelData =JSON.parse(sellsteel);

    function slocalstorage4()
    {
        sellsteelData.quantity = qty1;
        sellsteelData.quality_1 = q1;
        sellsteelData.quality_2 = q2;
        sellsteelData.quality_3 = q3;
