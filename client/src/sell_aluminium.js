...
function App() {
    ...
    const sellalumData =JSON.parse(sellalum);

    function slocalstorage5()
    {
        sellalumData.quantity = qty1;
        sellalumData.quality_1 = q1;
        sellalumData.quality_2 = q2;
        sellalumData.quality_3 = q3;
   ...
   function Check2(){
    ...
    function Check3(){
      ...
      function Checkqty(){
        if((qty1>0 && qty1 <=25)){   slocalstorage5()        /*variables from backend*/
          console.log("success");
