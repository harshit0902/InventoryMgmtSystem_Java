...
import com.harshit.miniproject.service.NewsletterService;
...
public class NewsletterController {
    ...
    public void insertNewsletter(@RequestParam Long id , @RequestParam String text, @RequestParam Type type, @RequestParam String moreInfo, @RequestParam String link){
